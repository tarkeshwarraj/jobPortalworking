  ...
  return (
    <div className='border p-6 shadow rounded' >
        ...
        <div className='flex items-center gap-3 mt-2 text-xs'>
          ...
          <span className='bg-red-50 border-blue-200 px-4 py-1.5 rounded'>{job.level}</span>
        </div>
        <p className='text-gray-500 text-sm mt-4' dangerousSetInnerHTML={{__html:job.description.slice(0,150)}}></p>
